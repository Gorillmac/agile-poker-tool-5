...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-7xl mx-auto">
        <div className="glass rounded-2xl p-8 md:p-12 shadow-card text-center animate-on-scroll transition-all duration-700 ease-out opacity-0 translate-y-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Estimate Agile Stories with <span className="text-primary-600">Lekker</span> <span className="text-primary-600">Simplicity</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-800 mb-10 max-w-3xl mx-auto">
            Plan smarter sprints with real-time collaborative estimation, howzit integration, 
            whiteboards, and exports — all in one powerful tool for South African teams.
          </p>
        ...
        <div className="glass rounded-2xl p-8 md:p-12 shadow-card animate-on-scroll transition-all duration-700 ease-out opacity-0 translate-y-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              ...
              <h3 className="text-xl font-semibold text-center text-gray-900 mb-3">Create a Lekker Session</h3>
              <p className="text-gray-700 text-center">Create a Planning Poker room and invite your team members to join remotely from anywhere in South Africa.</p>
            </div>
            ...
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              ...
              <h3 className="text-xl font-semibold text-center text-gray-900 mb-3">Estimate Together, Okes!</h3>
              <p className="text-gray-700 text-center">Use real-time voting with Fibonacci cards and collaborate using our integrated whiteboard - no load shedding required!</p>
            </div>
            ...
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              ...
              <h3 className="text-xl font-semibold text-center text-gray-900 mb-3">Sync & Export, Sharp Sharp!</h3>
              <p className="text-gray-700 text-center">Push estimation results directly to your systems and export your sessions to PDF or CSV format. Works even on mobile data!</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 max-w-7xl mx-auto">
        <div className="glass rounded-2xl p-8 md:p-12 shadow-card animate-on-scroll transition-all duration-700 ease-out opacity-0 translate-y-10">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Features Built for South African Agile Teams</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 text-lg font-semibold text-gray-900">Eish! Real-Time Collaboration</h3>
              </div>
              <p className="text-gray-700">Estimate tasks live with teams across Cape Town, Joburg, Durban or anywhere in SA using instant feedback.</p>
            </div>
            ...
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 text-lg font-semibold text-gray-900">Kiff Multi-User Sessions</h3>
              </div>
              <p className="text-gray-700">Host braais of planning sessions with voting, re-voting, and lekker statistical analysis of results.</p>
            </div>
            ...
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 text-lg font-semibold text-gray-900">Howzit Notifications</h3>
              </div>
              <p className="text-gray-700">Get notified about session invites, voting starts/ends, and team activity in real-time - even works on MTN and Vodacom!</p>
            </div>
          </div>
        </div>
      </section>

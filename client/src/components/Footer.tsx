...
export const Footer: React.FC = () => {
  return (
    <footer className="glass-dark text-white py-12 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center">
              <Users className="h-8 w-8 text-primary-500" />
              <span className="ml-2 text-xl font-semibold text-white">Agile Poker</span>
            </div>
            <p className="mt-3 text-gray-400">Plan smarter sprints with our collaborative estimation tool.</p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/docs" className="text-gray-400 hover:text-white transition duration-300">Documentation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/careers" className="text-gray-400 hover:text-white transition duration-300">Careers</Link></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/terms" className="text-gray-400 hover:text-white transition duration-300">Terms of Service</Link></li>
              <li><Link href="/cookies" className="text-gray-400 hover:text-white transition duration-300">Cookie Policy</Link></li>
              <li><Link href="/gdpr" className="text-gray-400 hover:text-white transition duration-300">GDPR</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Agile Poker Tool. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="https://github.com" className="text-gray-400 hover:text-white transition duration-300" aria-label="GitHub">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://linkedin.com" className="text-gray-400 hover:text-white transition duration-300" aria-label="LinkedIn">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">

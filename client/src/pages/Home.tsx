      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-7xl mx-auto">
        <div className="glass rounded-2xl p-8 md:p-12 shadow-card text-center animate-on-scroll transition-all duration-700 ease-out opacity-0 translate-y-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Estimate Agile Stories with <span className="text-primary-600">Speed</span> and <span className="text-primary-600">Simplicity</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-800 mb-10 max-w-3xl mx-auto">
            Plan smarter sprints with real-time collaborative estimation, Trello integration, 
        ...
        <div className="glass rounded-2xl p-8 md:p-12 shadow-card animate-on-scroll transition-all duration-700 ease-out opacity-0 translate-y-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card-hover bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 shadow-card">
              ...
              <p className="text-gray-700 text-center">Push estimation results directly to Trello and export your sessions to PDF or CSV format.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card-hover bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-white/50 dark:border-gray-700/50 shadow-card transition-all duration-300 hover:shadow-card-hover">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 text-lg font-semibold text-gray-900">Push Notifications</h3>
              </div>
              <p className="text-gray-700">Get notified about session invites, voting starts/ends, and team activity in real-time.</p>
            </div>
          </div>
        </div>
      </section>
